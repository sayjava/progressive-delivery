...
const behavior = (process.env.BEHAVIOR || 'good').toLowerCase()
...
app.listen(PORT, () => console.log(`App listening at port ${PORT} with version ${version} and behavior ${behavior}`));